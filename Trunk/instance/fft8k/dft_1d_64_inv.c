...
int main(int argc, char * argv[])
{
	...
	fftwf_complex * fftIn = (fftwf_complex*)fftwf_malloc(sizeof(fftwf_complex) * 64);
    fftwf_complex * fftOut = (fftwf_complex*)fftwf_malloc(sizeof(fftwf_complex) * 64);
    ...
    fftwf_plan plan = fftwf_plan_dft_1d(64, fftIn, fftOut, FFTW_BACKWARD, FFTW_ESTIMATE);
